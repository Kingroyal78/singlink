...
singlink and official graphics clients do not collect or share personal data,
...
singlink will not collect your app list.

If your configuration contains `wifi_ssid` or `wifi_bssid` routing rules,
singlink uses the location permission in the background
