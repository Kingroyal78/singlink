...
| Platform                              | Client                                   |
|---------------------------------------|------------------------------------------|
| :material-android: Android            | [singlink for Android](./android/)       |
| :material-apple: iOS/macOS/Apple tvOS | [singlink for Apple platforms](./apple/) |
| :material-laptop: Desktop             | Working in progress                      |

Some third-party projects that claim to use singlink or use singlink as a selling point are not listed here. The core
