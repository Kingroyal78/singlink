...
!!! note ""
    ...
    Will be automatically reloaded if file modified since singlink 1.10.0.
...
!!! failure "Deprecated in singlink 1.14.0"
    ...
    `download_detour` is deprecated in singlink 1.14.0 and will be removed in singlink 1.16.0, use `http_client` instead.
